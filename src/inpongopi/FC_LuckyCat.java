 ...
 */
public class FC_LuckyCat extends javax.swing.JFrame {

    /**
     * Creates new form FC_LuckyCat
     */
    public FC_LuckyCat() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 470, 150, 60));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FK_luckyCat.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/QGtHRKyr9MYBkfFWA "));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_LuckyCat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_LuckyCat().setVisible(true);
            }
        });
    }
