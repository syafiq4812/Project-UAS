 ...
 * @author ASUS
 */
public class FW_kita extends javax.swing.JFrame {

    /**
     * Creates new form FW_kita
     */
    public FW_kita() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnhome, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 460, 150, 70));

        Latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_warkop/FK_Kita.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/KBzbWcv5iTbg7xkBA"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_kita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
