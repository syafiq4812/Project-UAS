 ...
 * @author ThinkPad
 */
public class FC_kopiKenangan extends javax.swing.JFrame {

    /**
     * Creates new form FC_kopiKenangan
     */
    public FC_kopiKenangan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 470, 150, 70));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FM_kopken.png"))); // NOI18N
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_kopiKenangan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_kopiKenangan().setVisible(true);
            }
        });
    }
