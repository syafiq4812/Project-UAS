 ...
 */
public class FC_MenantiSenja extends javax.swing.JFrame {

    /**
     * Creates new form FC_MenantiSenja
     */
    public FC_MenantiSenja() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnback, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 470, 150, 70));
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_MenantiSenja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_MenantiSenja().setVisible(true);
            }
        });
    }
