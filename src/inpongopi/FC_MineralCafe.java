 ...
 */
public class FC_MineralCafe extends javax.swing.JFrame {

    /**
     * Creates new form FC_MineralCafe
     */
    public FC_MineralCafe() {
        initComponents();
    }
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/ZY6tQ5vgm1ZBK2j58"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_MineralCafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_MineralCafe().setVisible(true);
            }
        });
    }
