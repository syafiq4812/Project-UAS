 ...
 * @author ThinkPad
 */
public class FC_lamoenanCaffe extends javax.swing.JFrame {

    /**
     * Creates new form FC_lamoenanCaffe
     */
    public FC_lamoenanCaffe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 470, 150, 70));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FM_lamoenancafe.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/fH8ZCLzWZxwGbCdc7 "));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_lamoenanCaffe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_lamoenanCaffe().setVisible(true);
            }
        });
    }
