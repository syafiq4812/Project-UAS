 ...
 * @author ASUS
 */
public class FW_puaKale extends javax.swing.JFrame {

    /**
     * Creates new form FW_pua
     */
    public FW_puaKale() {
        initComponents();
    }
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/MkzX8eybey2MnVfx8"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_puaKale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FW_puaKale().setVisible(true);
            }
        });
    }
