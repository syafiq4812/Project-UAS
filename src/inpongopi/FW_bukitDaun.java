 ...
 * @author ASUS
 */
public class FW_bukitDaun extends javax.swing.JFrame {

    /**
     * Creates new form FW_bukitDaun
     */
    public FW_bukitDaun() {
        initComponents();
    }
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/d2GN3yicuhh3FFc5A"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_bukitDaun.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FW_bukitDaun().setVisible(true);
            }
        });
    }
