 ...
 * @author ThinkPad
 */
public class FC_Kopitagram extends javax.swing.JFrame {

    /**
     * Creates new form FC_Kopitagram
     */
    public FC_Kopitagram() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 470, 150, 60));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FM_kopitagram.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/MPgh9k2fS58uYnwp8"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_Kopitagram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_Kopitagram().setVisible(true);
            }
        });
    }
