 ...
 * @author ASUS
 */
public class FW_abdulMajid extends javax.swing.JFrame {

    /**
     * Creates new form FW_abdulMajid
     */
    public FW_abdulMajid() {
        initComponents();
    }
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_abdulMajid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FW_abdulMajid().setVisible(true);
            }
        });
    }
