 ...
 */
public class FC_KoziCafe extends javax.swing.JFrame {

    /**
     * Creates new form FC_KoziCafe
     */
    public FC_KoziCafe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 470, 140, 60));
        ...
        getContentPane().add(btnhome, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 470, 140, 60));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FK_Kozi.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/XtGQ8gXcSTNTgfwm6"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_KoziCafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_KoziCafe().setVisible(true);
            }
        });
    }
