 ...
 * @author ASUS
 */
public class FW_Roemah extends javax.swing.JFrame {

    /**
     * Creates new form FW_Roemah
     */
    public FW_Roemah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnback, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 460, 140, 70));
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_warkop/FM_roemah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_Roemah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
