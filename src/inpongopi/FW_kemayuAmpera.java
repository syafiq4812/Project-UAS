 ...
 * @author ASUS
 */
public class FW_kemayuAmpera extends javax.swing.JFrame {

    /**
     * Creates new form FW_kemayuAmpera
     */
    public FW_kemayuAmpera() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnfinish, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 470, 140, 70));
        ...
        getContentPane().add(btnback, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 470, 140, 70));
        ...
        getContentPane().add(btnhome, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 470, 140, 70));

        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_warkop/FM_Kemayu.png"))); // NOI18N
        latar.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/e89KwLzCrkAKPcsy9"));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_kemayuAmpera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FW_kemayuAmpera().setVisible(true);
            }
        });
    }
