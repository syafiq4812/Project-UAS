 ...
 * @author ASUS
 */
public class FW_djajaAbadi extends javax.swing.JFrame {

    /**
     * Creates new form FW_djajaAbadi
     */
    public FW_djajaAbadi() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FW_djajaAbadi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FW_djajaAbadi().setVisible(true);
            }
        });
    }
