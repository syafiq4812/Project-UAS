 ...
 * @author ThinkPad
 */
public class FC_KinaCafe extends javax.swing.JFrame {

    /**
     * Creates new form FC_KinaCafe
     */
    public FC_KinaCafe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        latar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image_cafe/FM_kina.png"))); // NOI18N
...
try {
        browser.browse(new URI ("https://maps.app.goo.gl/SbFR9kM2FWo3VFpY7 "));
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FC_KinaCafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FC_KinaCafe().setVisible(true);
            }
        });
    }
